...
if( isset($_POST['submit']) )
{
  ...
  $query = mysqli_query($con,"select id from employeedetail where ID='$empid' and 	emp_password='$cpassword'");
  $row = mysqli_fetch_array($query);
  if( $row > 0 ){
  $ret = mysqli_query($con,"UPDATE employeedetail SET emp_password='$newpassword' WHERE ID='$empid'");
