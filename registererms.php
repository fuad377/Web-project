...
if(isset($_POST['submit']))
  {
    ...
    $ret = mysqli_query($con, "SELECT emp_email FROM employeedetail WHERE emp_email='$Email'");
    ...
    if( $result > 0 ){
      ...
      $query=mysqli_query($con, "INSERT INTO employeedetail(emp_first_name, emp_last_name, emp_code, emp_email,  emp_password) value('$FName', '$LName', '$empcode', '$Email', '$Password' )");
